...
% | Code | Meaning                                                             |
% | ---- | ------------------------------------------------------------------- |
% | `h`  | **Here** — try to place figure exactly here (not always respected)  |
% | `t`  | **Top** of the page                                                 |
% | `b`  | **Bottom** of the page                                              |
% | `p`  | On a **special page** just for floats                               |
% | `H`  | Exactly *here*, from `float` package (disables floating entirely)   |
% | `!`  | **Override** LaTeX's internal constraints (e.g., allow more floats) |
...
% \begin{table}
%     \caption{Summary of model ROC AUCs in Cohort 2 independent test set} \label{table:auc-comparison}
%     \begin{tabularx}{\textwidth}{X >{\raggedleft\arraybackslash}X >{\raggedleft\arraybackslash}X >{\raggedleft\arraybackslash}X >{\raggedleft\arraybackslash}X}
%         \toprule
%         \multirow{2}{*}{\textbf{Classes}} & \multicolumn{4}{c}{\textbf{AUC}}                                                         \\
%         \cmidrule(lr){2-5}
%                                           & \textbf{DNAmPY}                  & \textbf{mCigarette} & \textbf{ENSS} & \textbf{Linear} \\
%         \midrule
%         Never vs Current                  & \num{0.991}                      & \num{0.994}         & \num{0.971}   & \num{0.990}     \\
%         \addlinespace
%         Ex vs Current                     & \num{0.915}                      & \num{0.923}         & \num{0.859}   & \num{0.918}     \\
